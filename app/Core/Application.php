...
final class Application
{
    ...
    public static function boot(string $basePath): self
    {
        ...
        // 1. Ortam ayarlarını yükle. cPanel paketinde .env zorunlu değildir;
        // kurulum sihirbazı config/installation.php dosyasını oluşturabilir.
        $envFile = $basePath . '/.env';
        if (is_file($envFile)) {
            Env::load($envFile);
        } elseif (is_file($basePath . '/config/installation.php')) {
            $installation = require $basePath . '/config/installation.php';
