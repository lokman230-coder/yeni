    ...
    private static function schema(): array
    {
        return [
            ...
            'payment' => [
                ...
                ['section'=>'🛒 Shopier'],
                ['key'=>'shopier.pat', 'label'=>'Personal Access Token (PAT)', 'type'=>'password', 'hint' => 'Shopier > Hesap Yonetimi > Kisisel Erisim Anahtari alanindan olusturulur. Yeni Shopier API icin ana alandir.'],
                ['key'=>'shopier.api_key',    'label'=>'Eski API Key (opsiyonel)',    'type'=>'password', 'hint' => 'Sadece eski Shopier api_pay4 entegrasyon bilgilerin varsa doldur.'],
                ['key'=>'shopier.api_secret', 'label'=>'Eski API Secret (opsiyonel)', 'type'=>'password'],
            ],
            'einvoice' => [
            ...
            'ai' => [
                ['key'=>'ai.provider','label'=>'Sağlayıcı','type'=>'select','options'=>['heuristic'=>'Heuristic (Ücretsiz Kural-Tabanlı)','openai'=>'OpenAI','gemini'=>'Google Gemini','claude'=>'Anthropic Claude','deepseek'=>'DeepSeek','mistral'=>'Mistral'],'default'=>'heuristic'],
                ['key'=>'ai.api_key', 'label'=>'OpenAI API Key',   'type'=>'password','hint'=>'OpenAI seçildiğinde kullanılır'],
                ['key'=>'ai.model',   'label'=>'OpenAI Model',     'type'=>'text','default'=>'gpt-4o-mini','hint'=>'Örn: gpt-4o-mini, gpt-4o'],
                ['key'=>'ai.gemini_api_key','label'=>'Gemini API Key','type'=>'password','hint'=>'Gemini seçildiğinde kullanılır'],
                ['key'=>'ai.gemini_model','label'=>'Gemini Model','type'=>'text','default'=>'gemini-2.0-flash','hint'=>'Örn: gemini-2.0-flash'],
                ['key'=>'ai.claude_api_key','label'=>'Claude API Key','type'=>'password'],
                ['key'=>'ai.claude_model','label'=>'Claude Model','type'=>'text','default'=>'claude-3-5-sonnet-latest'],
                ['key'=>'ai.deepseek_api_key','label'=>'DeepSeek API Key','type'=>'password'],
                ['key'=>'ai.deepseek_model','label'=>'DeepSeek Model','type'=>'text','default'=>'deepseek-chat'],
                ['key'=>'ai.mistral_api_key','label'=>'Mistral API Key','type'=>'password'],
                ['key'=>'ai.mistral_model','label'=>'Mistral Model','type'=>'text','default'=>'mistral-small-latest'],
                ['key'=>'ai.chat_provider','label'=>'Public/Müşteri AI sağlayıcısı','type'=>'select','options'=>['openai'=>'OpenAI','gemini'=>'Gemini','claude'=>'Claude','deepseek'=>'DeepSeek','mistral'=>'Mistral','heuristic'=>'Heuristic'],'default'=>'openai'],
                ['key'=>'ai.admin_provider','label'=>'Admin AI sağlayıcısı','type'=>'select','options'=>['openai'=>'OpenAI','claude'=>'Claude','gemini'=>'Gemini','deepseek'=>'DeepSeek','mistral'=>'Mistral','heuristic'=>'Heuristic'],'default'=>'openai'],
                ['key'=>'ai.builder_provider','label'=>'Site Builder AI sağlayıcısı','type'=>'select','options'=>['claude'=>'Claude','openai'=>'OpenAI','gemini'=>'Gemini','deepseek'=>'DeepSeek','mistral'=>'Mistral','heuristic'=>'Heuristic'],'default'=>'claude'],
                ['key'=>'ai.mobile_provider','label'=>'Mobile Builder AI sağlayıcısı','type'=>'select','options'=>['gemini'=>'Gemini','claude'=>'Claude','openai'=>'OpenAI','deepseek'=>'DeepSeek','mistral'=>'Mistral','heuristic'=>'Heuristic'],'default'=>'gemini'],
                ['key'=>'mobile.worker_url','label'=>'Mobile Build Worker URL','type'=>'url','placeholder'=>'https://worker.example.com'],
                ['key'=>'mobile.worker_key','label'=>'Mobile Worker API Key','type'=>'password'],
                ['key'=>'mobile.github_owner','label'=>'GitHub Owner','type'=>'text','placeholder'=>'kullanici veya organizasyon'],
                ['key'=>'mobile.github_repo','label'=>'GitHub Repository','type'=>'text','placeholder'=>'ahost-mobile'],
                ['key'=>'mobile.github_token','label'=>'GitHub Actions Token','type'=>'password'],
                ['key'=>'mobile.github_workflow','label'=>'GitHub Workflow','type'=>'text','default'=>'mobile-build.yml'],
                ['key'=>'mobile.github_branch','label'=>'GitHub Branch','type'=>'text','default'=>'main'],
                ['key'=>'mobile.github_project_path','label'=>'GitHub Project Path','type'=>'text','placeholder'=>'projects/{project_id}','hint'=>'Workflow icindeki mobil proje klasoru. Bos birakilirsa projects/{project_id} kullanilir.'],
                ['key'=>'mobile.enable_apk','label'=>'APK üretimini aktif et','type'=>'checkbox','default'=>false,'hint'=>'Kapalıysa public ve müşteri ekranlarında APK görünmez.'],
                ['key'=>'mobile.enable_aab','label'=>'AAB üretimini aktif et','type'=>'checkbox','default'=>false,'hint'=>'Kapalıysa public ve müşteri ekranlarında AAB görünmez.'],
                ['key'=>'mobile.enable_source','label'=>'Kaynak kod export aktif','type'=>'checkbox','default'=>true],
                ['key'=>'mobile.enable_pwa','label'=>'PWA export aktif','type'=>'checkbox','default'=>true],
            ],
            'sms' => [
            ...
            'security' => [
                ...
                ['section'=>'reCAPTCHA'],
                ['key'=>'security.recaptcha_enabled','label'=>'reCAPTCHA aktif','type'=>'bool','default'=>'0'],
                ['key'=>'security.recaptcha_site_key','label'=>'reCAPTCHA Site Key','type'=>'text'],
                ['key'=>'security.recaptcha_secret_key','label'=>'reCAPTCHA Secret Key','type'=>'password'],
