    ...
    <div style="display:grid;grid-template-columns:240px 1fr;gap:20px" class="aho-settings-layout">
        ...
        <div class="aho-card" style="padding:12px;height:fit-content;position:sticky;top:20px">
            <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:2px">
                ...
                <?php endforeach; ?>
                <li style="border-top:1px solid var(--aho-color-border);margin-top:8px;padding-top:8px">
                    <a href="/admin/temalar"
                       style="display:flex;gap:8px;align-items:center;padding:10px 12px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:500;color:var(--aho-color-ink-700);background:transparent;">
                        <span>🎨</span>
                        Temalar
                    </a>
                </li>
                <li>
                    <a href="/admin/tema-bloklari"
                       style="display:flex;gap:8px;align-items:center;padding:10px 12px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:500;color:var(--aho-color-ink-700);background:transparent;">
                        <span>🧩</span>
                        Tema Bloklari
                    </a>
