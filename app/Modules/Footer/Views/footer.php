        ...
        <div class="aho-ftr__grid">
            <div class="aho-ftr__col aho-ftr__col--brand">
                ...
                <p class="aho-ftr__desc">
                    <?= e(site_setting('site.description', 'Modern, güvenilir hosting, domain ve dijital hizmet platformu. Kendi sitenizi ve mobil uygulamanızı dakikalar içinde inşa edin.')) ?>
                </p>
            ...
            <div class="aho-ftr__col">
                ...
                <ul>
                    <?php $footerMenu = site_menu('footer'); if ($footerMenu): foreach ($footerMenu as $item): ?><li><a href="<?= e($item['url'] ?? '#') ?>"><?= e($item['label'] ?? '') ?></a></li><?php endforeach; else: ?>
            ...
            <div class="aho-ftr__col">
                ...
                <ul>
                    <li>📞 <?= e(site_setting('company.phone', '0850 000 00 00')) ?></li>
                    <li>✉️ <?= e(site_setting('company.email', 'destek@ahost.web.tr')) ?></li>
                    <li>📍 <?= e(site_setting('company.address', 'İstanbul, Türkiye')) ?></li>
                </ul>
