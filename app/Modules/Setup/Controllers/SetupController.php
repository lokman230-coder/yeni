...
final class SetupController
{
    ...
    public function createAdmin(Request $request): Response
    {
        ...
        try {
            ...
            $role = Connection::selectOne("SELECT id FROM admin_roles WHERE slug = 'super-admin' OR is_system = 1 ORDER BY id ASC LIMIT 1");
    ...
    private static function systemChecks(): array
    {
        ...
        return [
            ...
            'env_write' => ['ok' => $writable(AHO_ROOT . '/.env'), 'label' => '.env yazılabilir',  'value' => $writable(AHO_ROOT . '/.env')?'✓':'✗',  'required' => true],
