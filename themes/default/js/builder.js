...
(function (App) {
    ...
    const Builder = {
        ...
        renderBlock(block, i) {
            ...
            return `
                <div class="aho-bldr-block" data-bldr-block-index="${i}" draggable="true" title="Sürükleyerek sırayı değiştir">
        ...
        renderProps() {
            ...
            const styleKeys = ['bg_color','text_color','bg_image','padding_y','padding_x','font_size'];
